...
- [Hashicorp Waypoint - easy way to build, deploy and release applications](https://www.waypointproject.io/docs/getting-started)
- [Zabbix, Time Series Data and TimescaleDB – Zabbix Blog](https://blog.zabbix.com/zabbix-time-series-data-and-timescaledb/6642/)
- [PromScale - Observability backend powered by Timescaledb & PostgreSQL](https://blog.timescale.com/blog/what-are-traces-and-how-sql-yes-sql-and-opentelemetry-can-help-us-get-more-value-out-of-traces-to-build-better-software/)
...
- [Signoz -  Open Source Opentelemetry based Observability platform](https://signoz.io/)
- [Centralized logging with Signoz](https://dev.to/signoz/centralized-logging-with-open-source-tools-opentelemetry-and-signoz-45m6)
