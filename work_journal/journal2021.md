...
- Gift cards 
    ...
    - Money laundering - In one extremely literal example of regulatory arbitrage, some states (in US) require closed loop gift cards to be redeemable for cash. The miscreants recalculate ways to turn misappropriated value into physical gift cards located in these states, then sends a casher out to the store to collect clean cash.

- Cash flow in Insurance industry 
  - In between the present (premium) and the future (policy maturity or claim), the company has cash. In insurance, by regulation and practice this would be invested in a portfolio of largely low-risk highly-liquid assets, and the insurer would keep the returns generated by that portfolio, allowing it to be profitable potentially even if it had eventual claims higher than the premiums it took in. 

## 2021-dec-16 Thu

- Investing#Chemical space, 
    - Basic - india not present
    - Intermidiates - only 2-3 companies doing well
    - API - only 2-3 companies doing well

- Social#While Arguing, 
    - When we make and listen to statements, let's bucket them in 3 broad categories:
        - Factual: Claims about facts. I.e. a thing most people agree is true/false
        - Predictive: Claims about future states of the world.
...
- Finance#Supplier credit  
    - Whats in it for  supplier?  faster clearance of inventory especially if goods are perishable/limited shelf life; it drives sales; up-to-date picture of how customer's business is faring , simple by looking at his orders; ensures that credit is being used for what it is meant for (i.e. against the goods provided).
    - These are typically short term (upto 90 days) loans. those with greater duration are clubbed into "Vendor financing"
